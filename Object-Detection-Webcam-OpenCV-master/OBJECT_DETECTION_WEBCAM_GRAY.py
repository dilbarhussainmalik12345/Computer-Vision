"""OBJECT DETECTION WEB CAM"""
# GRAY SCALE
# quite similar as object detection
...
while True:
    ...
    gray_img = cv2.resize(gray_img, (int(gray_img.shape[1]/scale_factor),int(gray_img.shape[0]/scale_factor)))    
